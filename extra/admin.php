...
<body id="background1">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark">
	  <div class="container-fluid">
	    ...
	    <a class="navbar-brand text-light" href="#"><h2>Laumila</h2></a>
...
<div class="container px-4 py-1" id="custom-cards">
    <h2 class="pb-2 border-bottom">Pedidos</h2>
	<br>
    <div class="row row-cols-1 row-cols-lg-1 align-items-stretch g-4 py-1 px-4 bg-light">
		<?php
			$user = $_GET['id'];	
			$db->ordenes($user);	
		?>        	
